...
import 'package:flutter_rust_bridge/flutter_rust_bridge_for_generated_web.dart';
                ...
                abstract class VaultRustApiImplPlatform extends BaseApiImpl<VaultRustWire> {
                  VaultRustApiImplPlatform({
...
class VaultRustWire implements BaseWire {
            VaultRustWire.fromExternalLibrary(ExternalLibrary lib);

            
        }
        @JS('wasm_bindgen') external VaultRustWasmModule get wasmModule;

        @JS() @anonymous extension type VaultRustWasmModule._(JSObject _) implements JSObject {
